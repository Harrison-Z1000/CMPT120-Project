...
def main_game(location, score):
    ...
    says in a menacing tone.""")
                ...
                print("""   You tell him that you are on a mission to save 
    ...
    anxiousness.""")
                playerName = input("    Your Highness, please call me (enter "
                                   "your name) ")
                print("    'Head back to Vindauga immediately, Svend and",
...
def go_to(location, firstVisit, score):
    # This function handles changing the player's location and score Player
    # only gains 5 points the first time they visit a location in the game
...
def early_exit(score):
    ...
    print('\n')
    print("""    'Vindauga' was developed by Harrison Zheng 
...
def ending_copyright(score):
    ...
    print('\n')
    print("""    'Vindauga' was developed by Harrison Zheng 
    (Harrison.Zheng1@marist.edu), Will Dye (George.Dye1@marist.edu), and 
    Brendan Pacheco (Brendan.Pacheco1@marist.edu). Thank you for playing! 
                                                        Final Score:""", score)
    raise SystemExit
