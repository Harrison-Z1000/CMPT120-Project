...
def main():
    ...
    score = 0
    # Lines 17-21 tell the back story of the game
...
You see a worn path that leads to a few huts not too far off in the distance and decide to follow it. \n""")
    input("Press Enter to continue.")
    # Sets player to the second location in the game
    location = "Village"
    score = score + 5
    # Separates text user has already read from new text
    print('\n')
...
leader, Mother Agatha, claiming that he had an urgent message to deliver. The Council called for a meeting and 
there, the stranger told of how the citizens of his village had lost all sense of meaning and only someone as 
wise as Mother Agatha could show them the light. But she sensed that this man could not be trusted and ordered 
the guards to escort him out of Vindauga. As the guards marched over to the stranger, he suddenly opened his 
arms, unleashing a strong gust of wind and revealing a pair of large raven-like wings. Before anyone could regain 
their balance, he snatched Mother Agatha and flew away. Since then, the Council has been arguing over who should 
take her place and very little has been done to improve the lives of Vindaugans. As a result, many families, 
craftsmen, and merchants have left to settle elsewhere. Traders hardly ever come to Vindauga anymore either.' You 
ask the man where the stranger might have taken Mother Agatha, to which he responds, 'It’s likely that he brought 
her back to his village, which we suspect sits beyond those mountains.' He points to a mountain range about ten 
miles out. 'We have sent many soldiers to go look for our beloved Mother Agatha, but none have returned.' With 
only a hint of nervousness in your voice, you tell the man that you will find Mother Agatha and restore order. 
You add that it may be the only way to get back to your world. Seeing your determination, the man says 'Very well 
then. But before you embark on this quest, you will need some supplies.' He runs to a nearby hut and returns a 
moment later with a sword, a shield, and a couple of canteens filled with water. 'My father gave me this sword 
and this shield so that I could defend myself and all the things that I love. However, I am sure you will be 
doing just that in the days to come so please accept this as a humble gift.' Taking the slightly worn, 
yet sturdy, weapons in your hands, you thank him and set a course for the mountains. \n""")
    input("Press Enter to continue.")
    # Sets player to the third location in the game
    location = "Mountains"
    score = score + 5
    print('\n')
    # Lines 59-75 describe player's progress in the mountains
    print("""You reach the foot of the mountains a few hours later as the sun begins to set. Only then do you realize 
how tall the mountains are. As you start climbing, you get the feeling that you are being watched. A dark figure 
suddenly brushes past you. You unsheathe the sword that the villager gave you just in time to slash the beast as 
it lunges at you with its long claws and full set of razor-like teeth. You figure that you should find a place to 
...
it back to the village, how was I supposed to? As we began walking, I started to think about all the things that 
I wouldn’t be able to do if I died on this mission; make pottery for the village and travelers, build my own 
house, find a girl whom I love, and start my own family. Eventually, I decided to tell the other villagers I was 
traveling with that I needed some time to myself and that they should go on without me.' You tell Svend why you 
are going on this mission and try to convince him that the whole village is counting on him. He eventually gives 
in, saying 'If I’m not going to do it myself, then I suppose I could at least protect the person who will.' \n""")
    input("Press Enter to continue.")
    # Sets player to the fourth location in the game
    location = "Forest"
    score = score + 5
    print('\n')
    # Lines 82-95 describe player's progress in the forest
    print("""The next morning, you and Svend reach the summit of the mountain. From there, you see a vast expanse of 
trees stretching out into the distance. 'It looks like we still have a long way to go,' says Svend. The descent 
turns out to be much easier than the ascent. By the time you and Svend enter the forest, however, the sun is 
beginning to set again. The two of you split up to search for sticks that can be used to make a shelter and a 
fire. You collect several branches and twigs from the tall trees surrounding you, but stop when you hear a rustle 
in the leaves above. You grab your sword and your shield as the rustles accompanied by faint chortles grow more 
and more frequent. Finally, something jumps out of the trees and you swing your sword at it almost too late. It 
looked like a monkey, but with long fangs, and it was much larger than any monkey you had seen before. Many more 
of them jump out at you and you slash and block as quick as you can, only barely holding them off. One of them 
goes straight for your head with its arms outstretched and you think that this is it, you are going to die in 
this game. At this moment, a spear flies over your head and hits the creature right in the chest. You turn around 
to see Svend running towards you. 'You were gone for so long, I knew you must have been in trouble. Looks like I 
