...
def main():
    ...
    inventory = []
    player_object = Player(name, 5, "VILLAGE", 0, inventory)
...
def title_intro():
    ...
    print("Make sure to use 50 moves or less to reach the end of the game in "
          "order to win it! \n")
    # Tells the back story of the game and the player's progress in the meadow
    print("""    Today looked like it was going to be just like any other day.
    After listening to teachers lecture about things you do not care the
    least about for seven and a half hours at school, you finally make it to
    the safe haven of your room. You start up your computer and insert the
    game that you just got for your birthday. Suddenly, a blinding white
    light comes beaming out of your monitor. When you wake up, you find
    yourself lying in a meadow. You see a worn path that leads to a few huts
...
def main_game(player_object):
    ...
    while moves_count(player_object, player_object.moves) <= 50:
        ...
        cmd = cmd.upper()
        if player_object.location == location_list[1]:
            if cmd == "WALK TO HUTS":
                print('\n')
                # Describes the player's progress in the village
                print("""   Upon arriving at the village, you see a sign with
    symbols from a foreign language. A tall, middle-aged man
    walks by and you decide to ask him some questions. 'Well
    hello there! You must be new here. What is your name?' You
    tell him to call you""", player_object.name, "and ask him where you are.\n"
                                            "'It is a pleasure to meet you",
                      player_object.name + """'. The name of the
    ...
    set a course for the mountains. \n""")
                # Holds a Boolean value of True for every location visited
                # so far
                firstVisitList = [True * 2]
                newPlayerObject = Player.change_location(player_object, location_list[1], firstVisitList[-1], player_object.score)
            ...
            if cmd == "ASCEND MOUNTAINS":
                ...
                print("""   You reach the foot of the mountains a few hours
    later as the sun begins to set. Only then do you realize how
    tall the mountains are. As you start climbing, you get the
    ...
    says in a menacing tone. You tell him that your name is""", player_object.name, """and that you are on a mission to save
    ...
    who will.' \n""")
                ...
                newPlayerObject = Player.change_location(player_object, location_list[2], firstVisitList[-1], player_object.score)
                main_game(newPlayerObject)
            elif cmd == "HELP":
                list_commands()
                continue
            ...
            if cmd == "REST IN CAVE":
                ...
                print("""    That night, you and Svend take turns sleeping and
    guarding the cave. The next morning, you two reach the
    summit of the mountain. From there, you see a vast expanse
    ...
    night. \n""")
                ...
                newPlayerObject = Player.change_location(player_object, location_list[3], firstVisitList[-1], player_object.score)
                main_game(newPlayerObject)
            elif cmd == "HELP":
                list_commands()
                continue
            ...
            if cmd == "LEAVE TENT":
                ...
                print("""    The two of you spend the next morning trying to
    find a way out of the forest. You stumble upon a thicket of
    ...
    can fit in your rucksack. \n""")
                ...
                newPlayerObject = Player.change_location(player_object, location_list[4], firstVisitList[-1], player_object.score)
                main_game(newPlayerObject)
            elif cmd == "HELP":
                list_commands()
                continue
            ...
            if cmd == "KEEP WALKING":
                ...
                print("""    You and Svend walk for about another mile before
    reaching a creek with cool, pristine water. What a relief,
    you thought. The feeling left in your mouth by those tart
    berries from earlier was beginning to bother you. The two of
    you fill up your canteens and decide to follow the creek
    downstream. \n""")
                firstVisitList = [True * 6]
                newPlayerObject = Player.change_location(player_object, location_list[5], firstVisitList[-1], player_object.score)
                main_game(newPlayerObject)
            elif cmd == "HELP":
                list_commands()
                continue
            ...
            if cmd == "WALK ALONG CREEK":
                ...
                print("""    As you and Svend continue your trek through the
    forest, you constantly scan the trees, making sure that
    there are no monsters stalking either of you. Soon, the two
    of you come across some footprints. You suspect that there
    ...
    swift blow to the head. \n""")
                ...
                newPlayerObject = Player.change_location(player_object, location_list[6], firstVisitList[-1], player_object.score)
                main_game(newPlayerObject)
            elif cmd == "HELP":
                list_commands()
                continue
            ...
            if cmd == "ENTER BARNHOUSE":
                ...
                print("""    Inside the structure, there is a prison cell
    ...
    anxiousness. You tell her that she can call you""", player_object.name,
    "'Head back to Vindauga immediately, Svend and", player_object.name +
    ...
    from the sky and lifts you away. \n""")
                input("Press ENTER to continue. \n")
                ending_copyright(player_object.score)
            elif cmd == "HELP":
                list_commands()
                continue
            elif cmd == "MAP":
...
def moves_count(player_object, total_moves):
    # Keeps track of how many moves the player has made
    player_object.moves = total_moves + 1
    total_moves = player_object.moves
    return total_moves
